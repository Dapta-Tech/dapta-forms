...
export default async function SubmissionsPicker() {
  ...
  return (
    <div className="mx-auto max-w-[1520px] px-6 py-10 sm:px-8">
      <PageHeader title={p.submissionsTitle} subtitle={p.submissionsSubtitle} />
      {forms.length === 0 ? (
              ...
              >
                <div className="min-w-0">
                  ...
                  <span className="mt-0.5 block text-sm text-muted-foreground">
                    {t(p.submissionsCount, { n: analytics[i]?.submissions ?? 0 })}
                  </span>
                </div>
