...
ALTER TABLE connected_calendar ADD COLUMN last_check_at INTEGER;
ALTER TABLE connected_calendar ADD COLUMN last_check_ok INTEGER;
ALTER TABLE connected_calendar ADD COLUMN last_check_detail TEXT;
