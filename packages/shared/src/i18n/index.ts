...
export const en: FormsMessages = {
  ...
  admin: {
    ...
    brandKit: {
      ...
      applyButton: 'Apply to {count} forms',
      applying: 'Applying…',
      appliedToast: 'Brand kit applied to {count} forms.',
...
export const es: FormsMessages = {
  ...
  admin: {
    ...
    brandKit: {
      ...
      applyButton: 'Aplicar a {count} formularios',
      applying: 'Aplicando…',
      appliedToast: 'Kit de marca aplicado a {count} formularios.',
