...
export const en: FormsMessages = {
  ...
  admin: {
    ...
    integrations: {
      ...
      extraHubspotBody:
        'This screen only edits the first one, so the other is invisible here — and any edit on this tab saves right away and deletes it, along with whatever it was sending to HubSpot. Check what it maps before you change anything here. To send one answer to several properties, add the properties to the same question above instead.',
...
export const es: FormsMessages = {
  ...
  admin: {
    ...
    integrations: {
      ...
      extraHubspotBody:
        'Esta pantalla solo edita la primera, así que la otra es invisible acá — y cualquier cambio en esta pestaña se guarda al instante y la elimina, junto con todo lo que estuviera enviando a HubSpot. Revisa qué asigna antes de cambiar algo acá. Para mandar una respuesta a varias propiedades, agrega las propiedades a la misma pregunta de arriba.',
