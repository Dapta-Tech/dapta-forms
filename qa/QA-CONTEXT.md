...
- **Editor tabs**: Build · Logic · Connect · Results · Design, synced to `?tab=` (deep-linkable). Testids `editor-tab-<id>` (mobile bar suffixed `-mobile`). Old `/admin/forms/:id/integrations` route redirects to `edit?tab=connect`.
